...
const RecentAnalyses = () => {
  ...
  return (
    <div className="mt-8 bg-white dark:bg-gray-800 shadow overflow-hidden sm:rounded-lg transition-all duration-200 hover:shadow-lg" role="region" aria-labelledby="recent-analyses-heading">
      ...
      <div className="border-t border-gray-200 dark:border-gray-700 max-h-96 overflow-y-auto overflow-x-hidden">
          ...
          {recentAnalyses.map((analysis, index) => (
            <li key={index} className="hover:bg-gray-50 dark:hover:bg-gray-700 transition-all duration-200">
              <button
                ...
                className="w-full text-left px-4 py-6 sm:px-6 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 font-button transition-all duration-200 hover:translate-x-1"
